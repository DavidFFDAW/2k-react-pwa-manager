...
export function ButtonSecondary({ text, type, onClick, disabled = false }) {
    return <Button disabled={disabled} text={text} type={type} onClick={onClick} className={'cta-secondary'} />;
}
...
export function DangerButton({ text, type, onClick, disabled = false }) {
    return (
        <Button disabled={disabled} text={text} type={type} onClick={onClick} className={'action-button danger-action'} />
    );
}

export function GreyButton({ text, type, onClick, disabled = false }) {
    return (
        <Button disabled={disabled} text={text} type={type} onClick={onClick} className={'action-button default-action'} />
    );
}
